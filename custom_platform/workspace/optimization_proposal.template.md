...
- If specialized, why is the specialized property a real API/production invariant rather than a benchmark artifact?
- Decision: proceed / reject before implementation
...
- Is the current kernel design-boundary limited by reference/profile/model evidence? yes / no
