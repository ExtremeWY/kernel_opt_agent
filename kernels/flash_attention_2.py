"""CUDA FlashAttention-2 style forward kernel wrapper."""
...
def _validate_inputs(q: torch.Tensor, k: torch.Tensor, v: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def kernel_fn(
    ...
    return _EXTENSION.flash_attention_2_forward(q, k, v, float(sm_scale), bool(causal))
