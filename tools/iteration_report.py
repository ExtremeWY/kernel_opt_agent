...
def render_iteration_markdown(record: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- route type: {route.get('route_type') or 'none'}",
        ...
        f"- milestone: {route.get('milestone') or 'none'}",
        f"- milestone status: {route.get('milestone_status') or 'none'}",
        ...
        f"- invariant satisfied: {route.get('invariant_satisfied')}",
        f"- old bottleneck removed: {route.get('old_bottleneck_removed')}",
        f"- failure class: {route.get('failure_class') or 'none'}",
        f"- negative evidence scope: {route.get('negative_evidence_scope') or 'none'}",
        f"- blocks: {', '.join(route.get('blocks') or []) or 'none'}",
        f"- does not block: {', '.join(route.get('does_not_block') or []) or 'none'}",
        "",
        "## Guidance",
